...
**************************************************************************************/
  ...
  $name_crater = 'Adams';   // Name to label crater with
  ...
  /**--------------------------------------------------------------------------------
  "Lockyer", an IAU-named crater located southwest of "Adams"
  --------------------------------------------------------------------------------**/
  ...
  /**--------------------------------------------------------------------------------
  "Tombaugh", an IAU-named crater located further southwest of "Adams"
  --------------------------------------------------------------------------------**/
  ...
  // $lat_crater = -23.43;			// Degrees North
  ...
  // $lat_crater = -29.31;			// Degrees North
